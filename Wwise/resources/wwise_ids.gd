...
class EVENTS:
	...
	const DIATESTEVENTFUCK : int = 1352907638
	const DIATESTEVENTFUCKSHIT : int = 3898300188
	const PLAYTESTTONE : int = 2052572755
	const MUSIC_TESTMUSIC : int = 353884890
...
class BANKS:
	...
	const DIALOGUESOUNDBANK : int = 2237187046
	const MUSICSOUNDBANK : int = 3427827313
